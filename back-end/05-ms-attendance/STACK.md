...
> **Database:** `../database/05-ms-attendance-db` (schema `attendance`) · **Puerto:** `8085`
...
- **DB:** `cd ../database/05-ms-attendance-db && docker compose up` o `cd ../database && docker compose up -d`
- **Servicio:** ver `../../fae-docs/_stacks/java-spring.md` § Tools and minimum versions + `SERVICE.md` § Configuración (puerto `8085`)
