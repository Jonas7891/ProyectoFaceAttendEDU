package com.faceattend_edu.iotDevice.infrastructure.persistence.adapter;

import com.faceattend_edu.iotDevice.domain.model.IotDevice;
import com.faceattend_edu.iotDevice.domain.port.IotDeviceRepositoryPort;
import com.faceattend_edu.iotDevice.infrastructure.persistence.entity.IotDeviceEntity;
import com.faceattend_edu.iotDevice.infrastructure.persistence.mapper.IotDeviceRepositoryMapper;
import com.faceattend_edu.iotDevice.infrastructure.persistence.repository.IotDeviceJpaRepository;
