...
export const VISION_PRESETS: Record<VisionMode, AccessibilityPreset[]> = {
    normal: [
...
export const VISION_DESCRIPTIONS: Record<VisionMode, string> = {
...
export const DEFAULT_ACCENT:      string     = hsl(217, 76, 52);
export const DEFAULT_MODE:        ThemeMode  = "light";
export const DEFAULT_VISION_MODE: VisionMode = "normal";