...
const ROLE_ITEMS: { value: AppUserRole; label: string; description: string; icon: string }[] = [
...
export default function RegisterStudentModal({
    ...
    // Ítems de estado
    const statusItems = [
        { value: "active"   as const, label: t("Activo"),   icon: "check-circle" },
        { value: "inactive" as const, label: t("Inactivo"), icon: "x-circle"     },
    ];
    ...
    return (
        <>
            ...
            >
                ...
                {error && (
                    <View style={{
                        backgroundColor: c.states.dangerLight, borderRadius: 8,
                        padding: 12, flexDirection: "row", gap: 8, marginBottom: 16,
                    }}>
                ...
                {success && (
                    <View style={{
                        backgroundColor: c.states.successLight, borderRadius: 8,
                        padding: 12, flexDirection: "row", gap: 8, marginBottom: 16,
                    }}>
                ...
                <View style={{ marginBottom: 14 }}>
                    <Text style={{ fontSize: 12, fontWeight: "600", color: c.text.secondary, marginBottom: 8 }}>
                        {t("Estado")}
                    </Text>
