...
export const mockStudents = [
    ...
    { id: "2", name: "Carlos Rodríguez Mora", email: "c.rodriguez@uni.edu", code: "2021002", course: "Ingeniería de Sistemas", grade: "4to semestre", attendance: 88, status: "active",   registered: true  },
    ...
    { id: "4", name: "Luis Herrera Díaz",     email: "l.herrera@uni.edu",   code: "2021004", course: "Ingeniería Civil",       grade: "2do semestre", attendance: 75, status: "active",   registered: false },
    { id: "5", name: "Sofia Pérez Muñoz",     email: "s.perez@uni.edu",     code: "2021005", course: "Matemáticas",            grade: "3er semestre", attendance: 60, status: "inactive", registered: true  },
    { id: "6", name: "Andrés Vargas Castro",  email: "a.vargas@uni.edu",    code: "2021006", course: "Ingeniería Civil",       grade: "5to semestre", attendance: 85, status: "active",   registered: true  },
    { id: "7", name: "Valentina Cruz Lozano", email: "v.cruz@uni.edu",      code: "2021007", course: "Ingeniería de Sistemas", grade: "4to semestre", attendance: 91, status: "active",   registered: true  },
    { id: "8", name: "Daniel Ramírez Pinto",  email: "d.ramirez@uni.edu",   code: "2021008", course: "Matemáticas",            grade: "1er semestre", attendance: 78, status: "active",   registered: false },
];

export const mockCourses = [
    { id: "1", name: "Algoritmos y Estructuras de Datos", code: "AED-401", professor: "Dr. Felipe Torres",   students: 45, schedule: "Lun/Mié 8:00–10:00",      room: "Aula 301",        semester: "2024-2", avgAttendance: 87, color: "#4F6BED" },
    { id: "2", name: "Cálculo Diferencial",               code: "MAT-201", professor: "Dra. Patricia Soto", students: 38, schedule: "Mar/Jue 10:00–12:00",     room: "Aula 105",        semester: "2024-2", avgAttendance: 92, color: "#10B981" },
    { id: "3", name: "Física I",                          code: "FIS-101", professor: "Dr. Mauricio Reyes", students: 42, schedule: "Lun/Mié/Vie 7:00–8:00",   room: "Lab. Física",     semester: "2024-2", avgAttendance: 78, color: "#F59E0B" },
    { id: "4", name: "Programación Orientada a Objetos",  code: "POO-301", professor: "Ing. Sandra Varela", students: 35, schedule: "Mar/Jue 14:00–16:00",     room: "Lab. Computación",semester: "2024-2", avgAttendance: 85, color: "#8B5CF6" },
    { id: "5", name: "Bases de Datos",                    code: "BD-401",  professor: "Dr. Hugo Méndez",    students: 40, schedule: "Vie 8:00–12:00",           room: "Lab. Computación",semester: "2024-2", avgAttendance: 90, color: "#EF4444" },
    { id: "6", name: "Pizzas de Datos",                   code: "PD-101",  professor: "Dr. Hugo Verdosa",   students: 30, schedule: "Lun 8:00–12:00",           room: "Aula 301",        semester: "2024-2", avgAttendance: 83, color: "#EF4444" },
];

export const mockAttendanceByDay = [
    { day: "Lun", present, absent, late: 8  },
    { day: "Mar", present, absent, late: 12 },
    { day: "Mié", present, absent, late: 6  },
    { day: "Jue", present, absent, late: 14 },
    { day: "Vie", present, absent, late: 9  },
];
