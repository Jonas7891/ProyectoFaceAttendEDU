const urlBase="../services/endpoints/";

export const schools="api/schools"
export const persons="api/persons"
export const roles="api/roles"
export const users="api/users"
export const userRoles="api/userRoles"
export const courses="api/courses"
export const classrooms="api/classrooms"
export const periods="api/periods"
export const schedules="api/schedules"
export const enrollments="api/enrollments"
export const iotDevices="api/iotDevices"
export const attendances="api/attendances"
export const justifications="api/justifications"
...
export const userRolesUrl=urlBase + userRoles;
