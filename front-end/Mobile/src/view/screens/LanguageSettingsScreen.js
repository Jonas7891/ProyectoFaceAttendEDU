                            ...
                            >
                                ...
                                <View
                                    style={{
                                        ...
                                        borderBottomWidth: 1,
                                        borderBottomColor:
                                            colors.border ?? colors.textSecondary + '20',
                                        marginBottom: 5,
                                    }}
                                >
                                    <View
                                    ...
                                    <Switch
                                        ...
                                        onValueChange={() => toggleAlertType('success')}
                                        trackColor={{
                                ...
                                >
                                    ...
                                    <Switch
                                        ...
                                        onValueChange={() => toggleAlertType('warning')}
                                        trackColor={{
                                            false: colors.textSecondary + '40',
                                            true: (colors.warning ?? '#FF9800') + '70',
                                        }}
                                        thumbColor={
                                ...
                                >
                                    ...
                                    <Switch
                                        ...
                                        onValueChange={() => toggleAlertType('confirm')}
                                        trackColor={{
                                            false: colors.textSecondary + '40',
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {t('settings.iotAlertsDesc')}
                                        </Text>
                                    </View>

                                    <Switch
                                        value={alertsConfig.enableIot}
                                        onValueChange={() => toggleAlertType('iot')}
                                        trackColor={{
                                            false: colors.textSecondary + '40',
                                            true: (colors.danger ?? '#F44336') + '70',
                                        }}
                                        thumbColor={
                                            alertsConfig.enableIot
